...
recipes.addShapeless(<deepmoblearning:data_model_thermal_elemental>, [<deepmoblearning:data_model_blank>,<ore:anyThermalDust>]);
...
alloyer.recipeBuilder()
    .inputs(<minecraft:clay_ball>, <ore:enrichedEggPlastic>*8)
