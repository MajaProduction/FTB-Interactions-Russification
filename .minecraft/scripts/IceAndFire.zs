...
for color in dragonColors {
	...
	[<iceandfire:troll_leather_mountain>, <minecraft:leather_boots>, <iceandfire:troll_leather_mountain>], 
	[<ore:screwSteel>, <iceandfire:troll_leather_mountain>, <ore:screwSteel>]]);

	recipes.addShaped(<iceandfire:mountain_troll_leather_leggings>, 
	[[<ore:screwSteel>, <iceandfire:troll_leather_mountain>, <ore:screwSteel>],
	[<iceandfire:troll_leather_mountain>, <minecraft:leather_leggings>, <iceandfire:troll_leather_mountain>], 
	[<ore:screwSteel>, <iceandfire:troll_leather_mountain>, <ore:screwSteel>]]);
