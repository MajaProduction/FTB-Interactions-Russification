...
print("---------------Rustic Start------------------");
	...
	#Blazing Orchid
	mods.thaumcraft.Infusion.registerRecipe("blazingOrchid", "INFUSION", <plants2:nether_harvest>, 4, [<aspect:ignis> * 64, <aspect:herba> * 32, <aspect:desiderium> *16], <randomthings:lotusseeds>,
	[<minecraft:vine>,<minecraft:vine>,<deepmoblearning:pristine_matter_blaze>,<deepmoblearning:pristine_matter_blaze>,<botania:manaresource:1>,<botania:manaresource:1>]);
