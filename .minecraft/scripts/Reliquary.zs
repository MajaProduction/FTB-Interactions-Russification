...
mods.thaumcraft.ArcaneWorkbench.registerShapedRecipe("reliquarycrimsoncloth", "", 5, [<aspect:perditio>*5, <aspect:ignis>*5 ], <xreliquary:mob_ingredient:15>,
	...
	[<minecraft:nether_star>,<xreliquary:mob_ingredient:9>, <extrautils2:ingredients:10>]);	
...
alloyer.recipeBuilder()
	...
	#MagicBane harder recipe
	recipes.remove(<xreliquary:magicbane>);
mods.thaumcraft.Infusion.registerRecipe("magicbane", "INFUSION", <xreliquary:magicbane> , 4,
	[<aspect:alienis> * 16, <aspect:praecantatio> * 64, <aspect:perditio> * 16, <aspect:ordo> * 16],
	<tconstruct:sword_blade>.withTag({Material: "electrum"}),
	[<xreliquary:mob_ingredient:11>, <ore:stickSterlingSilver>.firstItem, <ore:stickRoseGold>.firstItem]);
