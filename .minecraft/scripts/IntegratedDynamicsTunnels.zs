...
centrifuge.recipeBuilder()
	...
	.fluidOutputs([<liquid:methane> * 50,<liquid:menrilresin> * 250])
...
assembler.recipeBuilder()
	.inputs([<integratedtunnels:part_importer_world_block_item>])
...
assembler.recipeBuilder()
	.inputs([<integratedtunnels:part_exporter_world_block_item>])
	.outputs(<integratedtunnels:part_importer_world_block_item>)
	.EUt(16)
	.duration(80)
	.buildAndRegister();

	#Importers clear data
recipes.addShapeless(<integratedtunnels:part_importer_world_block_item>, [<integratedtunnels:part_importer_world_block_item>]);
recipes.addShapeless(<integratedtunnels:part_exporter_world_block_item>, [<integratedtunnels:part_exporter_world_block_item>]);
