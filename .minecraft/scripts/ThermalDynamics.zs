...
val chemReactor = mods.gregtech.recipe.RecipeMap.getByName("chemical_reactor");
	...
	#retrievers to servos
	recipes.addShapeless(<thermaldynamics:servo:4>, [<thermaldynamics:retriever:4>]);
	recipes.addShapeless(<thermaldynamics:servo:3>, [<thermaldynamics:retriever:3>]);
	recipes.addShapeless(<thermaldynamics:servo:2>, [<thermaldynamics:retriever:2>]);
	recipes.addShapeless(<thermaldynamics:servo:1>, [<thermaldynamics:retriever:1>]);
	recipes.addShapeless(<thermaldynamics:servo>, [<thermaldynamics:retriever>]);
