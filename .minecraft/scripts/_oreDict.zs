...
#colored smart cables
var coloredSmartCables as IItemStack[] = [
...
for i in coloredSmartCables {
	<ore:coloredSmartCable>.add(i);
}

#colored dense cables
var coloredDenseCables as IItemStack[] = [
...
for i in coloredDenseCables  {
	<ore:coloredDenseCable>.add(i);
}
...
#brick conversions
furnace.addRecipe(<minecraft:brick_block>,<ceramics:clay_hard>);
