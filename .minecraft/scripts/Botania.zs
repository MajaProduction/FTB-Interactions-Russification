...
mods.thaumcraft.Infusion.registerRecipe("jadedamaranthus", "INFUSION", <botania:specialflower>.withTag({type: "jadedAmaranthus"}), 5, 
	...
	#overgrowth seed
mods.thaumcraft.Infusion.registerRecipe("overgrowth", "INFUSION", <botania:overgrowthseed>, 4,
	[<aspect:herba> * 16, <aspect:potentia> * 12, <aspect:praecantatio> * 32, <aspect:desiderium> * 12], <actuallyadditions:item_misc:23>,
	[<ore:powderMana>,<ore:powderMana>,<ore:powderMana>,<ore:powderMana>,<thermalfoundation:fertilizer:2>,<thermalfoundation:fertilizer:2>,<thermalfoundation:fertilizer:2>,<thermalfoundation:fertilizer:2>]);	
...
mods.astralsorcery.Altar.addAttunementAltarRecipe("interactions:kekimurus", <botania:specialflower>.withTag({type: "kekimurus"}), 250, 200, [
	...
	#sash of the traveler
mods.astralsorcery.Altar.addAttunementAltarRecipe("interactions:sojourners", <botania:travelbelt>, 250, 200, [
	null, <minecraft:carpet>, null,
	<minecraft:brown_mushroom>, <thaumcraft:baubles:2>, <botania:manaresource:23>,
	null, <ore:blockCoal>, null,
	<ore:ingotManasteel>,<ore:ingotManasteel>,null,null,]);
...
mods.astralsorcery.Altar.addAttunementAltarRecipe("interactions:manapylonalternate", <botania:pylon>, 350, 200, [
	manaPlate, manaPlate, manaPlate,
	<ore:screwRoseGold>, <minecraft:nether_star>, <ore:screwRoseGold>,
	manaPlate, manaPlate, manaPlate,
	illuminationPowder,illuminationPowder,illuminationPowder,illuminationPowder]);	
...
mods.botania.ManaInfusion.addAlchemy(<botania:specialflower>.withTag({type: "shulk_me_not"}), <ore:gaiaIngot>, 750000);
	...
	#stibnite to bismuth
mods.botania.ManaInfusion.addAlchemy(<ore:oreBismuth>.firstItem, <ore:oreNetherrackStibnite>, 7500);
...
mods.botania.PureDaisy.addRecipe(<astralsorcery:blockinfusedwood:6>,<botania:livingwood>, 150);
	...
	#astral marble
mods.botania.PureDaisy.addRecipe(<ceramics:clay_hard>,<astralsorcery:blockmarble>, 150);	
...
mods.botania.ManaInfusion.addInfusion(<botania:manaresource>*2, <ore:ingotBluesteel>.firstItem, 5000);
...
recipes.addShaped(basicWand, [
    [<botania:petal:*>.marked("first"),null],
    [<botania:twigwand>.marked("wand"),<botania:petal:*>.marked("second")]
    ],
    function(out,ins,cInfo) {
        return ins.wand.updateTag({color1: ins.first.damage, color2: ins.second.damage});
