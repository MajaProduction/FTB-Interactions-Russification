...
val alloyer = mods.gregtech.recipe.RecipeMap.getByName("alloy_smelter");
	...
	alloyer.recipeBuilder()
		.inputs(<ore:foilZinc>*8,<bhc:relic_apple>)
...
mods.astralsorcery.Altar.addConstellationAltarRecipe("interactions:greenheart", <bhc:green_heart>, 1500, 600, [
	...
	alloyer.recipeBuilder()
		.inputs(<botania:manaresource:1>, <cyclicmagic:apple_emerald>)
	...
	alloyer.recipeBuilder()
		.inputs(<botania:manaresource:1>, <minecraft:golden_apple:1>)
		.outputs(<bhc:relic_apple>)
		.duration(160)
		.EUt(28)
		.buildAndRegister();	
	...
	[<astralsorcery:itemcraftingcomponent>, <minecraft:ender_eye>, <astralsorcery:itemcraftingcomponent>]]);
