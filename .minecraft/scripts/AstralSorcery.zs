...
mods.astralsorcery.Altar.addTraitAltarRecipe("interactions:vorux", <astralsorcery:itemconstellationpaper>.withTag({astralsorcery: {constellationName: "astralsorcery.constellation.vorux"}}), 4500, 400, [
	...
	<astralsorcery:itemperkgem>.addTooltip(format.darkRed("Crafted in-world with glowstone dust and a rockcrystal in liquid starlight."));
	<astralsorcery:itemperkgem:1>.addTooltip(format.darkRed("Crafted in-world with glowstone dust and a rockcrystal in liquid starlight."));
	<astralsorcery:itemperkgem:2>.addTooltip(format.darkRed("Crafted in-world with glowstone dust and a rockcrystal in liquid starlight."));


	#Add constellation tooltip names
	<astralsorcery:itemconstellationpaper>.withTag({astralsorcery: {constellationName: "astralsorcery.constellation.discidia"}}).addTooltip(format.darkRed("discidia"));
	<astralsorcery:itemconstellationpaper>.withTag({astralsorcery: {constellationName: "astralsorcery.constellation.armara"}}).addTooltip(format.darkRed("armara"));
	<astralsorcery:itemconstellationpaper>.withTag({astralsorcery: {constellationName: "astralsorcery.constellation.vicio"}}).addTooltip(format.darkRed("vicio"));
	<astralsorcery:itemconstellationpaper>.withTag({astralsorcery: {constellationName: "astralsorcery.constellation.aevitas"}}).addTooltip(format.darkRed("aevitas"));
	<astralsorcery:itemconstellationpaper>.withTag({astralsorcery: {constellationName: "astralsorcery.constellation.evorsio"}}).addTooltip(format.darkRed("evorsio"));
	<astralsorcery:itemconstellationpaper>.withTag({astralsorcery: {constellationName: "astralsorcery.constellation.lucerna"}}).addTooltip(format.darkRed("lucerna"));
	<astralsorcery:itemconstellationpaper>.withTag({astralsorcery: {constellationName: "astralsorcery.constellation.mineralis"}}).addTooltip(format.darkRed("mineralis"));
	<astralsorcery:itemconstellationpaper>.withTag({astralsorcery: {constellationName: "astralsorcery.constellation.horologium"}}).addTooltip(format.darkRed("horologium"));
	<astralsorcery:itemconstellationpaper>.withTag({astralsorcery: {constellationName: "astralsorcery.constellation.octans"}}).addTooltip(format.darkRed("octans"));
	<astralsorcery:itemconstellationpaper>.withTag({astralsorcery: {constellationName: "astralsorcery.constellation.bootes"}}).addTooltip(format.darkRed("bootes"));
	<astralsorcery:itemconstellationpaper>.withTag({astralsorcery: {constellationName: "astralsorcery.constellation.fornax"}}).addTooltip(format.darkRed("fornax"));
	<astralsorcery:itemconstellationpaper>.withTag({astralsorcery: {constellationName: "astralsorcery.constellation.pelotrio"}}).addTooltip(format.darkRed("pelotrio"));
	<astralsorcery:itemconstellationpaper>.withTag({astralsorcery: {constellationName: "astralsorcery.constellation.gelu"}}).addTooltip(format.darkRed("gelu"));
	<astralsorcery:itemconstellationpaper>.withTag({astralsorcery: {constellationName: "astralsorcery.constellation.ulteria"}}).addTooltip(format.darkRed("ulteria"));
	<astralsorcery:itemconstellationpaper>.withTag({astralsorcery: {constellationName: "astralsorcery.constellation.alcara"}}).addTooltip(format.darkRed("alcara"));
	<astralsorcery:itemconstellationpaper>.withTag({astralsorcery: {constellationName: "astralsorcery.constellation.vorux"}}).addTooltip(format.darkRed("vorux"));
